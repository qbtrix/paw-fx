// bad-glsl-altered: a shader-gallery copy with one constant moved.
//
// There is no module around a .frag upstream, so this class of port copies the
// source. That makes the copy the thing to verify: line 34's noise lacunarity
// reads 2.07 here against upstream's 2.03. One character, no visible change to
// review by eye, and the gate has to see it. Nothing else in this file differs.
//
// SPDX-License-Identifier: MIT
// SPDX-FileCopyrightText: 2026 E. T. Carter <support@shader.gallery>

export const meta = { name: "bad-glsl-altered", version: "1.0.0", category: "backgrounds", needs: [], license: "MIT", options: {} };
...
uniform float u_driftSpeed;     // twilight drift speed              (default 0.14)
...
export function mount(el) {
  ...
  return { update() {}, destroy() { el.removeAttribute("data-fx-live"); }, source: FRAGMENT };
}
